...
public interface IHumlaSession {
    ...
    /**
     * Inject external audio data directly into the transmission pipeline.
     * This bypasses the microphone and transmits the provided audio directly to Mumble.
     * @param audioData PCM audio samples (16-bit signed, mono, 48kHz)
     * @return true if audio was successfully injected
     */
    boolean injectAudioData(short[] audioData);
    ...
    /**
     * Sets the mic boost (2x pre-amplification).
     * @param enabled True to enable 2x boost, false to disable.
     */
    void setMicBoost(boolean enabled);
    
    /**
     * Sets the output gain (speaker gain multiplier).
     * @param gain The gain multiplier (0.5 to 5.0 recommended).
     */
